...
fun RunCounterActionButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            disabledContainerColor = RunCounterGray,
            disabledContentColor = RunCounterBlack,
        ),
...
@Composable
fun RunCounterOutLineActionButton(
    text: String,
    isLoading: Boolean,
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
...
@Composable
private fun RunCounterActionButtonPreview() {
    RunCounterTheme{
...
@Preview(showBackground = true)
@Composable
private fun RunCounterOutLineActionButtonPreview() {
    RunCounterTheme {
